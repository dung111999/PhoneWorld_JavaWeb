				...
				<div id="collapseUtilities" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
							...
							Products</a> <a class="collapse-item" href="utilities-border.html">Add
							Products</a>
					</div>
				</div></li>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="signup-block bg">
						<h2 id="ha">Add Product</h2>
						<c:url value="/admin/product/add" var="addPro"></c:url>
						<form action="${addPro}" method="post" id="ha"
							enctype="multipart/form-data">
							<label for="exampleInputName">Name </label> <input type="text"
								name="name" placeholder="Name" required=""> <label
								for="exampleInputUsername">Price </label> <input type="text"
								name="price" placeholder="Price" required=""><label
								for="exampleInputUsername">Ram </label> <input type="text"
								name="ram" placeholder="Ram" required=""><label
								for="exampleInputUsername">Rom </label> <input type="text"
								name="rom" placeholder="Rom" required=""><label
								for="exampleInputUsername">CPU </label> <input type="text"
								name="CPU" placeholder="CPU" required=""><label
								for="exampleInputUsername">Pin </label> <input type="text"
								name="pin" placeholder="Pin" required=""> <label
							...
							<input type="submit" name="addPro" value="Submit"> </br>
						</form>
					</div>
				</div>
