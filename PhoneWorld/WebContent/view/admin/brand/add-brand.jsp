			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<h2 id="ha">Add Brand</h2>
						<c:url value="/admin/brand/add" var="addBrand"></c:url>
						<form action="${addBrand}" method="post" id="ha">
							<label for="exampleInputName">Name</label> <input type="text"
								name="brandname" placeholder="Name" required=""> <br>
							<input type="submit" name="addBrand" value="Submit"> </br>
						</form>
					</div>
