			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="signup-block bg">
						<h2 id="ha">Edit Brand</h2>
						<c:url value="/admin/brand/edit" var="editBrand"></c:url>
						<form action="${editBrand}" method="post" id="ha">
							Id <input type="text" readonly="readonly" name="id"
								value="${brand.id }"> <label for="exampleInputName">Name</label>
							<input type="text" name="brandname" placeholder="Name"
								required=""> <br> <input type="submit"
								name="editBrand" value="Submit"> </br>
						</form>
					</div>
