		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="${pageContext.request.contextPath}/admin/brand/list">List Brands</a> <a
							class="collapse-item"
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseUtilities" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="${pageContext.request.contextPath }/admin/product/list">List
							Products</a> <a class="collapse-item" href="${pageContext.request.contextPath }/admin/product/add">Add
							Products</a>
					</div>
				</div></li>

			<li class="nav-item"><a class="nav-link collapsed" href="${pageContext.request.contextPath }/admin/cart-item/list"
				data-target="#collapseUtilities" aria-expanded="true"
				aria-controls="collapseUtilities"> <span>Cart Items</span>
			</a></li>
			
			<li class="nav-item"><a class="nav-link collapsed" href="${pageContext.request.contextPath }/admin/order-table"
				data-target="#collapseUtilities" aria-expanded="true"
